...
export const FIRST_ID_BY_GEN: Record<number, number> = {
  1: 1,    // Generation 1 
  2: 152,  // Generation 2 
  3: 252,  // Generation 3 
  4: 387,  // Generation 4
...
export type PokemonTypeColorKey = keyof typeof typeColors;
...
export const truncateDescription = (text: string | null | undefined): string => {
    if (!text) {
