...
import type { EvolutionStage, MoveDetail, PokemonMoveRef, PokemonTypeSlot } from '../../types';
  ...
  useEffect(() => {
    const fetchPokemonDetails = async () => {
      ...
      try {
        ...
        const description = getEnglishDescription(speciesResponse.data.flavor_text_entries);
