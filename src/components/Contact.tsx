...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setStatusMessage(
        typeof apiMessage === 'string' ? apiMessage : 'Failed to send message. Please try again.',
      );
    } finally {
      setIsSending(false);
    }
      ...
      >
        ...
        >
          ...
          <Box sx={{ position: 'relative', p: { xs: 3, md: 4.5 } }}>
            ...
            >
              Have a question, found a bug, or want to share feedback? Send us a message and we'll
        ...
        >
          ...
          >
            ...
            <Stack spacing={2.5}>
                  ...
                  {TOPIC_OPTIONS.map((topic) => (
                    <Chip
                      ...
                      sx={{
                        ...
                        border: '1px solid',
                        borderColor: formData.subject === topic.subject ? '#FECACA' : '#E5E7EB',
                        '& .MuiChip-icon': {
              ...
              {statusMessage && (
                <Alert severity={statusType} sx={{ borderRadius: 3, fontWeight: 600 }}>
                  {statusMessage}
                </Alert>
              )}
